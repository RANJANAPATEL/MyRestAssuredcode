...
public class GetAccountBlocks {
	@Test
 public void getAccessBlockStatus()
 {
	...
	Response response = http_request.request(Method.GET,"/3/account/Ranjana1995/block");  
	...
	System.out.println(js.get("data.url"));
